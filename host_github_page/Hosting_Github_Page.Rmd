...
This exercise will allow you to create a basic web page that you can host on your GitHub account.

For this exercise, you will create a page with **your notes on R commands**. You will then host it on your GitHub page.

For this exercise, you will write your code in chunks but not execute the data. Use {r eval=FALSE, include=TRUE} in the header so the page will render without running the actual code.
