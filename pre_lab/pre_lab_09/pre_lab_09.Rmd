...
md_gov_county1 <- md_gov_county |>
  mutate(
    total_votes = Cox + Moore + Lashar + Wallace,
    pct_moore = round((Moore / total_votes) * 100, 1))
#Moore_pct = round((Moore/total)*100,1))
# Alternate method - mutate(total_votes = rowSums(across(3:8)))
...
**Answer Here** Put the URL of your map here: https://www.datawrapper.de/_/Ei4EZ/
