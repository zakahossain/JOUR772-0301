...
2.  The greater mean than median for most courses suggests that have a handful of extra large classes with lots of seats that is skewing the mean. There are also classes with zero seats, should those classes be dropped permanently if they have had zero enrollment for say n number of terms?
