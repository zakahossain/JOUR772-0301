...
**Answer** We made a new variable, selected_journalism_courses, to hold the result to simplify the dataset and to keep ourselves organised. 
...
**Answer**
We got 54000. OR operator returned far more seats because it is additive in nature.
...
**Answer:**
The <chr> in the first column changed to <date> and the dates are now formated as YYYY-MM-DD
...
**Answer** The month column is <date> and all the dates in a month are grouped into 1 row.
...
**Answer** I gives us the total number of votes cast and then the fraction of votes cast in favour of Moore over the total no. of votes cast.
...
**Answer** The column is arranged higher to lower vote for Moore in each county
...
**Answer** It helps us compare Moore's votes against others and also gives us what percentge of the total votes Moore has.
...
**Answer** We now have a column with states and uses state codes.
...
**Answer** Total contribution for each state is under "total" column
...
#1.  Does a course requre pre-requisite(s)? (UMD course)

#2.  Is the contributor an institution -- Business/Group/Organization or an individual? (Maryland expenditure)

#3.  What percent of funds came from an institution v. from an individual? What is the average an institution contributed v. average an individual contributed?
